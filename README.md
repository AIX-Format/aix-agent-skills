...
_Last updated: 2026-05-15 09:49 UTC_
...
### 🧩 Skill Registry — 67 Total Skills across 6 Tiers
...
| 📦 UNCLASSIFIED | 15 | `agent-memory`, `voice-wizard`, `aix-schema`, `api-route-standard`, `skills-system`, `vercel-deploy`, `antigravity-jules`, `persona-loader`, `aggressive-scalper`, `caveman-compressor`, `git-operator`, `gmail-integration`, `calendar-manager`, `data-analysis-engine`, `frontend-developer` |
...
|---|---|---|
| [`bcb8d43`](https://github.com/Moeabdelaziz007/aix-agent-skills/commit/bcb8d43) | feat: add 4 GemClaw skills to L3 marketplace | Mohamed Abdelaziz |
| [`b9b4eb7`](https://github.com/Moeabdelaziz007/aix-agent-skills/commit/b9b4eb7) | 📊 auto-update live ecosystem dashboard [skip ci] | iqra-dashboard-bot |
